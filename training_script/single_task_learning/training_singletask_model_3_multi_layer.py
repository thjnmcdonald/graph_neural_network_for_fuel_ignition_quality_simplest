...
class Net(torch.nn.Module):
    ...
    def forward(self, data, print_intermediaries = False):
        ...
        out_GCN_3 = F.relu(self.convGNN3(out_GCN_2, data.edge_index))

        out_scatter = scatter_add(out_GCN_3, data.batch, dim=0)
        ...
        if print_intermediaries == True:
            intermediate_values = [data.x, data.edge_index, out_GCN_1, out_GCN_2, out_GCN_3, out_scatter, out_ANN1, out_final]
        ...
        for data in loader:
            ...
            for mol in mol_id:
                ...
                if tmp_mol_name == 'CCCCl':
                    ...
                    torch.save(intermediate_values, save_path + "/intermediate_values.tar")
...
torch.save(state_dict, save_path + "/i_wanna_save.tar")
